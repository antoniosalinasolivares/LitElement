...
},{}],"node_modules/lit-element-router/lit-element-router.js":[function(require,module,exports) {
"use strict";
...
function router(base) {
  return class extends base {
    ...
    routing(routes, callback) {
      ...
      let activeRoute = routes.filter(route => route.pattern !== '*' && (0, _routerUtility.testRoute)(uri, route.pattern))[0];
      let query = (0, _routerUtility.parseQuery)(querystring);
...
},{"./utility/router-utility":"node_modules/lit-element-router/utility/router-utility.js"}],"src/home.js":[function(require,module,exports) {
"use strict";
...
var Home = /*#__PURE__*/function (_LitElement) {
  _inherits(Home, _LitElement);
...
},{"lit-element":"node_modules/lit-element/lit-element.js"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/data.js":[function(require,module,exports) {
"use strict";
...
var Data = /*#__PURE__*/function (_LitElement) {
  _inherits(Data, _LitElement);
  ...
  _createClass(Data, [{
    ...
    value: function getData() {
      ...
      _axios.default.get("https://api.datos.gob.mx/v2/Releases_SFP").then(function (res) {
        _this2.state = _toConsumableArray(res.data.results);

        if (_this2.state.length) {
          _this2.loaded = true;

          _this2.requestUpdate();
        } else {
          _this2.defaultMessage = "Hubo un error en el origen, intentelo mas tarde";
        }
      }).catch(function (err) {
        _this2.defaultMessage = "Hubo un error en el origen, intentelo mas tarde";
      });
    ...
    value: function createList() {
      return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <table style=\"width:100%\">\n        <tr>\n          <th>Comprador</th>\n          <th>Fecha</th>\n          <th>Publicante</th>\n          <th>Descripcion</th>\n          <th>Participantes</th>\n        </tr>\n        ", "\n      </table>\n    "])), this.state.map(function (row) {
        return (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <tr>\n            <th>", "</th>\n            <th>", "</th>\n            <th>", "</th>\n            <th>", "</th>\n            <th>", "</th>\n          </tr>\n        "])), row.buyer.name, row.date, row.publisher.name, row.tender.title, row.parties.map(function (part) {
          return (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<p>", "</p>"])), part.name);
        }));
      }));
    }
  }, {
...
},{"lit-element":"node_modules/lit-element/lit-element.js","axios":"node_modules/axios/index.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var App = /*#__PURE__*/function (_router) {
  ...
  _createClass(App, [{
    key: "render",
    value: function render() {
      return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n            ", "\n            ", "\n        "])), this.navBar(), this.home ? (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<home-view/>"]))) : (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<data-view/>"]))));
    }
  }, {
    key: "handleClickHome",
    ...
    key: "handleClickData",
    value: function handleClickData() {
      this.home = false;
      this.requestUpdate();
    }
  }, {
    ...
    value: function navBar() {
      return (0, _litElement.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        <a class=\"waves-effect waves-light btn\" @click=", "> Home</a>\n        <a> | </a>\n        <a class=\"waves-effect waves-light btn\" @click=", "> Consulta a la Secretaria de funcion p\xFAblica </a>\n        "])), this.handleClickHome, this.handleClickData);
    }
  }], [{
    key: "Properties",
    get: function get() {
...
},{"lit-element":"node_modules/lit-element/lit-element.js","lit-element-router":"node_modules/lit-element-router/lit-element-router.js","./home":"src/home.js","./data":"src/data.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "39471" + '/');
